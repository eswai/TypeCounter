...
let keydict:[Int: String] = [
    ...
    // ISO keyboards
    kVK_ISO_Section               : "ISO_Section",

    // JIS keyboards
    kVK_JIS_Yen                   : "JIS_Yen",
    kVK_JIS_Underscore            : "JIS_Underscore",
    kVK_JIS_KeypadComma           : "JIS_KeypadComma",
    kVK_JIS_Eisu                  : "JIS_Eisu",
    kVK_JIS_Kana                  : "JIS_Kana",
]
...
struct KeyCount: Identifiable {
    ...
    func keychar()-> String {
        let r = keydict[keycode]
        return r!
    }
    
    static func getKeyChar(code:Int)-> String {
        let r = keydict[code]
        return r!
    }
}
